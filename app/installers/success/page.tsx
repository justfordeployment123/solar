...
export default function InstallersSuccessPage() {
  return (
    <div className="bg-[#ffffff] min-h-screen text-[#363636] font-sans flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute top-[-20%] left-[20%] w-[60%] h-[60%] rounded-full bg-[#e12029]/10 blur-[150px] pointer-events-none" />
      ...
      <main className="w-full max-w-screen-md px-6 py-32 text-center relative z-10 flex flex-col items-center">
        ...
        >
          <div className="absolute -inset-4 bg-[#e12029]/20 rounded-full blur-xl" />
        ...
        >
          ...
          <div className="flex items-center gap-4 relative z-10">
            <p className="text-[#363636] font-mono font-medium text-sm md:text-base break-all bg-white p-4 rounded-xl border border-[#dfdfdf] flex-grow shadow-sm">
        ...
        >
          <Link href="/calculator/step-1">
            <Button variant="primary" className="px-10 py-6 text-lg shadow-apple-hover uppercase tracking-widest gap-3 rounded-full hover:scale-105 transition-transform bg-[#363636] hover:bg-[#363636] border-transparent text-white">
              Launch Calculator
